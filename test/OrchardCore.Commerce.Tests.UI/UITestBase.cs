...
internal class UITestBase : OrchardCoreUITestBase<Program>
{
    ...
    )
    {
        ...
        var testTask = ExecuteTestAsync(
            testAsync,
            browser,
            SetupHelpers.RunSetupAsync,
        ...
        if (timeoutTask.IsCompleted)
        {
            throw new TimeoutException(
                $"The time allotted for the test ({timeoutValue}) was exceeded."
            );
        }
        ...
        base.ExecuteTestAsync(
            ...
            async configuration =>
            {
                configuration
                    ...
                    .RunAccessibilityCheckingAssertionOnAllPageChanges = true;
                configuration.AccessibilityCheckingConfiguration.AxeBuilderConfigurator +=
                    axeBuilder =>
                        AccessibilityCheckingConfiguration
