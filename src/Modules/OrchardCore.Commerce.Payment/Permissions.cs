...
public class Permissions : AdminPermissionBase
{
    ...
    public static readonly Permission ManageAddressSettings = new(nameof(ManageAddressSettings), "Manage Address Settings");

    private static readonly IReadOnlyList<Permission> _adminPermissions = [ManageOrders, Checkout, ManageAddressSettings];
